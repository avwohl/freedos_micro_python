...
# calling `open('CLIENT.KEY')` from inside the test because `open()`
# after `import _ssh` deterministically wedges PMODE/W's DPMI
# dispatch — see port/dosint21_uc386dos.c and the WIP doc.
